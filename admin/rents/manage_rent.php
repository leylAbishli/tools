	...
	<div class="card-body">
		<form action="" id="rent-form">
			...
			<div class="col-md-6 form-group">
				<label for="tenant_id">Kirayəci</label>
			...
			<div class="col-md-6 form-group">
				<label for="unit_id">Ləvazimat adı</label>
			...
			<div class="form-group col-md-6">
				<label for="rent_type" class="control-laberl">Tip</label>
				<select name="rent_type" id="rent_type" class="form-control form-control-sm" required>
					<option value="1" <?php echo isset($rent_type) && $rent_type == 1 ? 'selected' : '' ?>>Aylıq</option>
					<option value="2" <?php echo isset($rent_type) && $rent_type == 2 ? 'selected' : '' ?>>Yarımillik</option>
					<option value="3" <?php echo isset($rent_type) && $rent_type == 3 ? 'selected' : '' ?>>İllik</option>
				</select>
			</div>
			<div class="form-group col-md-6">
				<label for="billing_amount" class="control-laberl">Qiymət</label>
			...
			<div class="form-group col-md-6">
				<label for="date_rented" class="control-laberl">Kirayə olunma tarixi</label>
			...
			<div class="form-group col-md-6">
				...
				<select name="status" id="status" class="form-control form-control-sm" required>
					...
					<option value="0" <?php echo isset($status) && $status == 0 ? 'selected' : '' ?>>Deaktiv</option>
				</select>
			</div>
		</form>
	</div>
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="rent-form">Yadda saxlayın</button>
		<a class="btn btn-flat btn-default" href="?page=rents">İmtina edin</a>
	</div>
</div>
<script>
