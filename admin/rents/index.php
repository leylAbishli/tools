...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Ləvazimatların siyahısı</h3>
		<div class="card-tools">
			<a href="?page=rents/manage_rent" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span> Yenisini yaradın</a>
		</div>
	</div>
	<div class="card-body">
						...
						?>
							<tr>
								...
								<td>
									...
									<small>Bitiş tarixi: <?php echo date("M d, Y", strtotime($row['date_end'])) ?></small>
								</td>
								<td>
									<?php
									switch ($row['status']) {
								...
								<td align="center">
									...
									<div class="dropdown-menu" role="menu">
										<a class="dropdown-item" href="?page=rents/manage_rent&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Modifikasiya Edin</a>
										<div class="dropdown-divider"></div>
										<a class="dropdown-item renew_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fa fa-retweet text-primary"></span> Yeniləyin</a>
										<div class="dropdown-divider"></div>
										<a class="dropdown-item delete_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fa fa-trash text-danger"></span> Silin</a>
									</div>
								</td>
							</tr>
						<?php endwhile; ?>
