...
<div class="container-fluid">
	<form action="" id="pricing-form">
		...
		<div class="form-group">
			<label for="unit_id" class="control-label">Ləvazimat adı</label>
		...
		<div class="form-group row px-2">
			<label for="monthly" class="control-label col-md-4">Aylıq</label>
		...
		<div class="form-group row px-2">
			<label for="quarterly" class="control-label col-md-4">Yarımillik</label>
		...
		<div class="form-group row px-2">
			<label for="annually" class="control-label col-md-4">İllik</label>
