...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span> Yenisini yaradın</a>
		</div>
	</div>
	<div class="card-body">
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td>
									<p class="truncate-3 m-0"><?php echo $row['description'] ?></p>
								</td>
								<td class="text-center">
									<?php if ($row['status'] == 0) : ?>
										<span class="badge badge-success">Əlçatan</span>
									<?php elseif ($row['status'] == 1) : ?>
										<span class="badge badge-secondary">Əlçatmaz</span>
									<?php else : ?>
										<span class="badge badge-danger">Yoxdu</span>
									<?php endif; ?>
								</td>
								...
								<td align="center">
									...
									<div class="dropdown-menu" role="menu">
										<a class="dropdown-item edit_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Modifikasiya Edin</a>
