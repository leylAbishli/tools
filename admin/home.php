...
<div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Ümumi ləvazimat sayı</span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Əlçatan ləvazimat sayı</span>
                <span class="info-box-number">
                  <?php 
          ...
          <!-- /.col -->
           ...
           <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Kirayə olunan ləvazimatlar</span>
                <span class="info-box-number">
                  <?php 
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Təmridə olanlar</span>
                <span class="info-box-number">
                  <?php 
